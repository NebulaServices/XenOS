...
document.addEventListener("userInactive", function () {
  ...
  frame.style =
    "overflow:none;outline:transparent;border:transparent;width:100%;height:100%;z-index:40000004;position: absolute;pointer-events:none;";
  frame.id = "saverFrame";
...
xen.webpack = {
  ...
  cache: __webpack_module_cache__,
};
